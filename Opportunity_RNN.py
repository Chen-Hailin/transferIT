...
# Network Parameters
n_input = 134 # opportunity data input (img shape: 28*28)
...
test_data = np.load(data_path + 'S1-ADL5.dat_data.npy')
test_activity_labels = np.load(data_path + 'S1-ADL5.dat_activity_labels.npy')
